...
def main():
    ...
    parser.add_argument("--checkpoint", default="./checkpoints/checkpoint_epoch50.pt",
    ...
    cond_emb_dim = 256  # must match your training

    # rebuild models
    unet = AttentionUNet(
        in_channels=3, base_channels=64,
        channel_mults=(1,2,4,8),
        time_emb_dim=256, cond_emb_dim=cond_emb_dim,
        out_channels=3
    ).to(device)
    ...
    embed.load_state_dict(
        ckpt.get("embed_state_dict", embed.state_dict())
    )
