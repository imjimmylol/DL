...
class DQNAgent:
    ...
    def run(self, episodes=10000):
        for ep in range(episodes):
            ...
            wandb.log({"Episode": ep, "Total Reward": total_reward, "Env Step Count": self.env_count, "Update Count": self.train_count, "Epsilon": self.epsilon})
            ...
            if ep % 20 == 0:
                ...
                wandb.log({"Eval Reward": eval_reward, "Env Step Count": self.env_count, "Update Count": self.train_count})
...
if __name__ == "__main__":
    ...
    config = load_config("./trainingcfg/task3_ddqn.yaml")
