...
class DQNAgent:
    def __init__(self, env_name="CartPole-v1", args=None):
        ...
        # Networks
        self.q_net = self.q_net = DuelingDQN(input_channels=4, num_actions=self.num_actions).to(self.device)
        self.q_net.apply(init_weights)
        self.target_net = DuelingDQN(input_channels=4, num_actions=self.num_actions).to(self.device)
...
if __name__ == "__main__":
    ...
    config = load_config("./trainingcfg/task3_mstep_dueling.yaml")
